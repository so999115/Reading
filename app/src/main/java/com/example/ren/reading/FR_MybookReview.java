...
public class FR_MybookReview extends Fragment {
    ...
    ListView mybook_review_listview;
    String mJsonString;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fr_mybook_review, container, false);

        mybook_review_listview = (ListView)rootView.findViewById(R.id.mybook_review_listview);
        mArrayList = new ArrayList<>();

        String email = GlobalApplication.gMemberInfo.getMemberEmailInfo();

        GetData task = new GetData();
        task.execute("http://so999115.cafe24.com/php/getmybookreview.php", email);
    ...
    private void showResult(){
        try {
            ...
            mybook_review_listview.setAdapter(adapter);
