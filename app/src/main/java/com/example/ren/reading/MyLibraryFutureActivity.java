...
public class MyLibraryFutureActivity extends AppCompatActivity {

    private BackBtnCloseHandler backBtnCloseHandler;

    FutureReadAdapter futureReadAdapter = null;
    ListView listview;
    MyBookDBHelper mydb = null;
    ArrayList<FutureReadBookInfo> futureReadBookInfo = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        futureReadBookInfo =mydb.fgetData();
        futureReadAdapter = new FutureReadAdapter(this,R.layout.my_library_listview_item,futureReadBookInfo);

        listview = (ListView)findViewById(R.id.book_listview);
        listview.setAdapter(futureReadAdapter);
        ...
        menu_home_btn.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(MyLibraryFutureActivity.this, MainActivity.class);
        ...
        menu_review_btn.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(MyLibraryFutureActivity.this, ReviewActivity.class);
                startActivity(intent);
            }
        });
        ...
        menu_diary_btn.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(MyLibraryFutureActivity.this, DiaryActivity.class);
                startActivity(intent);
            }
        });
        ...
        menu_setting_btn.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v) {
                Intent intent = new Intent(MyLibraryFutureActivity.this, SettingActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.action_search) {
            Intent intent = new Intent(MyLibraryFutureActivity.this, SearchBookActivity.class);
            startActivity(intent);
            return true;
        }
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.now_read_book_menu:
                        ...
                        Intent intent1 = new Intent(MyLibraryFutureActivity.this, MyLibraryActivity.class);
                        startActivity(intent1);
                        Toast.makeText(MyLibraryFutureActivity.this, "읽을 책", Toast.LENGTH_SHORT).show();
                        break;
                    ...
                    case R.id.past_read_book_menu:
                        ...
                        Intent intent2 = new Intent(MyLibraryFutureActivity.this, MyLibraryPastActivity.class);
